...
export function ShellLayout() {
  return (
    <div className="min-h-dvh bg-slate-50 text-slate-900 light:bg-slate-50 light:text-slate-900 pink:bg-gradient-to-br pink:from-pink-50 pink:via-rose-50 pink:to-fuchsia-50/90 pink:text-pink-950 dark:bg-slate-950 dark:text-slate-100">
      <header className="border-b border-slate-200 bg-white/80 backdrop-blur light:border-slate-200 light:bg-white/80 pink:border-pink-200/50 pink:bg-white/75 pink:backdrop-blur-md dark:border-slate-800 dark:bg-slate-950/80">
        <div className="mx-auto flex max-w-6xl flex-wrap items-center justify-between gap-3 px-4 py-3">
          <Link
            to="/"
            className="text-lg font-semibold tracking-tight text-indigo-600 pink:text-pink-700 dark:text-indigo-400"
          >
